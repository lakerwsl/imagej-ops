...
/**
 * Tests {@link PearsonsClassic}.
 *
 * @author Ellen T Arena
 */
public class PearsonsClassicTest extends ColocalisationTest {
	 ...
	 */
	@Test
	public void classicPearsonsZeroCorrTest() {
		PearsonsResult result = (PearsonsResult) ops.run(PearsonsClassic.class, zeroCorrelationImageCh1, zeroCorrelationImageCh2);
	 ...
	 */
	@Test
	public void classicPearsonsPositiveCorrTest() {
		PearsonsResult result = (PearsonsResult) ops.run(PearsonsClassic.class, positiveCorrelationImageCh1, positiveCorrelationImageCh2);
	...
	public void differentMeansTest()  {
		...
		for (double mean = initialMean; mean < 1; mean += spread) {
			...
			PearsonsResult resultClassic = (PearsonsResult) ops.run(PearsonsClassic.class, ch1, ch2, mean, mean);
			assertTrue(Math.abs(resultClassic.correlationValue) < 0.1);
		}
	}
